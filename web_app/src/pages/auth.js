            ...
            <div class="landing-auth-card">
              ...
              <div class="auth-segmented-control">
                <button class="auth-segment-btn ${!this.isSignUp ? 'active' : ''}" id="auth-tab-signin">
                  <span class="material-icons" style="font-size: 17px;">login</span>
                  <span>Sign In</span>
                </button>
                <button class="auth-segment-btn ${this.isSignUp ? 'active' : ''}" id="auth-tab-signup">
                  <span class="material-icons" style="font-size: 17px;">person_add</span>
              ...
              <div class="form-group">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  ...
                  ${!this.isSignUp ? `
                    <a href="#" id="auth-forgot-pwd" style="font-size: 12px; color: var(--primary); font-weight: 600;">Forgot?</a>
                  ` : ''}
                </div>
              ...
              <!-- Submit Button -->
              <button class="btn-auth-submit" id="auth-submit-btn" ${this.isLoading ? 'disabled' : ''} style="margin-top: 8px;">
                ${this.isLoading ? `
